...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [qUtils addTargetName:@"coverBack" atPath:@"Insania.xml"];
    [qUtils addTargetName:@"coverFront" atPath:@"Insania.xml"];
    [qUtils addTargetName:@"book" atPath:@"Insania.xml"];
    [qUtils addTargetName:@"bookFront" atPath:@"Insania.xml"];
