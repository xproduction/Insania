...
- (void)endSplash:(NSTimer*)theTimer
{
    ...
    if ([QCARutils getInstance].videoStreamStarted == YES)
    {
        ...
        //TODO: about view sem skoval, což je na prase, měl bych to odstranit komplet
        ...
        dispatch_async( dispatch_get_main_queue(), ^{
            [self presentViewController:aboutViewController animated:shouldAnimateTransition completion:nil];
        });
    }
}
